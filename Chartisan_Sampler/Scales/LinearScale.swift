...
struct LinearScale : GuideScale, Equatable {
    ...
    -> (min: Double, max: Double, chartSteps: [ChartStep])
    {
    ...
    private func linearScaleCalculator(data: [Double], currentMin: Double?, currentMax: Double?) -> (min: Double, max: Double, chartSteps: [ChartStep]) {
